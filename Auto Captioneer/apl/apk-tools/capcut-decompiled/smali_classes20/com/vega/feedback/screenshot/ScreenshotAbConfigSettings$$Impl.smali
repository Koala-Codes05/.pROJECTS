.class public Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = -0x2684d7d4
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl$1;-><init>(Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;)V

    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->getConfig()LX/3an;
...
.method public getConfig()LX/3an;
    .locals 7

    iget-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mockManager:LX/3iu;

    const-string v5, "lv_screen_shot_feedback"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl$2;-><init>(Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = lv_screen_shot_feedback time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-class v1, LX/3an;

    iget-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3an;->b()LX/3an;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null lv_screen_shot_feedback"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl$3;-><init>(Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = lv_screen_shot_feedback"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "common_settings_com.vega.feedback.screenshot.ScreenshotAbConfigSettings"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "lv_screen_shot_feedback"
    ...
    iget-object v1, p0, Lcom/vega/feedback/screenshot/ScreenshotAbConfigSettings$$Impl;->mStorage:LX/3iv;
