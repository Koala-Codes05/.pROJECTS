.class public Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = -0x893d3bd
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl$1;-><init>(Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;)V

    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->getConfig()LX/3d5;
...
.method public getConfig()LX/3d5;
    .locals 7

    iget-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mockManager:LX/3iu;

    const-string v5, "cc_template_prepare_ahead"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl$2;-><init>(Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = cc_template_prepare_ahead time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-class v1, LX/3d5;

    iget-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3d5;->b()LX/3d5;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null cc_template_prepare_ahead"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl$3;-><init>(Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = cc_template_prepare_ahead"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "cutsame_settings_com.vega.libcutsame.config.TemplatePrepareAheadSettings"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "cc_template_prepare_ahead"
    ...
    iget-object v1, p0, Lcom/vega/libcutsame/config/TemplatePrepareAheadSettings$$Impl;->mStorage:LX/3iv;
