.class public Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/cutsameedit/config/BusinessGenOptSettings;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x618bcf17
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl$1;-><init>(Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;)V

    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->getConfig()LX/3aQ;
...
.method public getConfig()LX/3aQ;
    .locals 7

    iget-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mockManager:LX/3iu;

    const-string v5, "vc_business_gen_opt"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl$2;-><init>(Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = vc_business_gen_opt time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v4, LX/3aQ;

    if-nez v4, :cond_2

    const-class v1, LX/3aQ;

    iget-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3aQ;->b()LX/3aQ;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null vc_business_gen_opt"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl$3;-><init>(Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = vc_business_gen_opt"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "prod_settings_com.vega.cutsameedit.config.BusinessGenOptSettings"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "vc_business_gen_opt"
    ...
    iget-object v1, p0, Lcom/vega/cutsameedit/config/BusinessGenOptSettings$$Impl;->mStorage:LX/3iv;
