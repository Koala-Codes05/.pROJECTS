.class public Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/edit/base/config/AiEraseConfigSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = -0x413d4785
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl$1;-><init>(Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;)V

    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->getConfig()LX/3a9;
...
.method public getConfig()LX/3a9;
    .locals 7

    iget-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "ai_erase_entrance_config"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl$2;-><init>(Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = ai_erase_entrance_config time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v4, LX/3a9;

    if-nez v4, :cond_2

    const-class v1, LX/3a9;

    iget-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3a9;->b()LX/3a9;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null ai_erase_entrance_config"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl$3;-><init>(Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = ai_erase_entrance_config"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "common_settings_com.vega.edit.base.config.AiEraseConfigSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "ai_erase_entrance_config"
    ...
    iget-object v1, p0, Lcom/vega/edit/base/config/AiEraseConfigSetting$$Impl;->mStorage:LX/3iv;
