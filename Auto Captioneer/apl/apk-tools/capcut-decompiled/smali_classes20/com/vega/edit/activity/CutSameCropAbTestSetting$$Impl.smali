.class public Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/edit/activity/CutSameCropAbTestSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x35f3682f
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl$1;-><init>(Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;)V

    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->getConfig()LX/3cl;
...
.method public getConfig()LX/3cl;
    .locals 7

    iget-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "template_asset_free_crop"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl$2;-><init>(Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = template_asset_free_crop time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3cl;->b()LX/3cl;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null template_asset_free_crop"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl$3;-><init>(Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = template_asset_free_crop"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "cutsame_settings_com.vega.edit.activity.CutSameCropAbTestSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "template_asset_free_crop"
    ...
    iget-object v1, p0, Lcom/vega/edit/activity/CutSameCropAbTestSetting$$Impl;->mStorage:LX/3iv;
