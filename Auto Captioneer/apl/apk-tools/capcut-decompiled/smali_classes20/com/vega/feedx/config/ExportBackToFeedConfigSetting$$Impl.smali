.class public Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/feedx/config/ExportBackToFeedConfigSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x55603435
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl$1;-><init>(Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;)V

    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->getConfig()LX/3Q7;
...
.method public getConfig()LX/3Q7;
    .locals 7

    iget-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "export_back_to_feed"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl$2;-><init>(Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = export_back_to_feed time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3Q7;->c()LX/3Q7;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null export_back_to_feed"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl$3;-><init>(Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = export_back_to_feed"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "common_settings_com.vega.feedx.config.ExportBackToFeedConfigSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "export_back_to_feed"
    ...
    iget-object v1, p0, Lcom/vega/feedx/config/ExportBackToFeedConfigSetting$$Impl;->mStorage:LX/3iv;
