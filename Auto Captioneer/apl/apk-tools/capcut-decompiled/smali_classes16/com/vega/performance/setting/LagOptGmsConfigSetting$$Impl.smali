.class public Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/performance/setting/LagOptGmsConfigSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x3662ecd
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl$1;-><init>(Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;)V

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->getConfig()LX/3dI;
...
.method public getConfig()LX/3dI;
    .locals 7

    iget-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "lag_opt_gms_config"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl$2;-><init>(Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = lag_opt_gms_config time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3dI;->c()LX/3dI;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null lag_opt_gms_config"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl$3;-><init>(Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = lag_opt_gms_config"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "performance_settings_com.vega.performance.setting.LagOptGmsConfigSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "lag_opt_gms_config"
    ...
    iget-object v1, p0, Lcom/vega/performance/setting/LagOptGmsConfigSetting$$Impl;->mStorage:LX/3iv;
