.class public Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/performance/setting/LagOptQ3ConfigSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = -0x2b511e3a
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl$1;-><init>(Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;)V

    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->getConfig()LX/37c;
...
.method public getConfig()LX/37c;
    .locals 7

    iget-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "lag_opt_q3_config"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl$2;-><init>(Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = lag_opt_q3_config time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-class v1, LX/37c;

    iget-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/37c;->b()LX/37c;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null lag_opt_q3_config"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl$3;-><init>(Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = lag_opt_q3_config"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "performance_settings_com.vega.performance.setting.LagOptQ3ConfigSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "lag_opt_q3_config"
    ...
    iget-object v1, p0, Lcom/vega/performance/setting/LagOptQ3ConfigSetting$$Impl;->mStorage:LX/3iv;
