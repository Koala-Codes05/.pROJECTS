.class public Lcom/vega/settings/IMetaDataConfig$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/settings/IMetaDataConfig;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = -0xe371dae
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/settings/IMetaDataConfig$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/settings/IMetaDataConfig$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/settings/IMetaDataConfig$$Impl$1;-><init>(Lcom/vega/settings/IMetaDataConfig$$Impl;)V

    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
# virtual methods
.method public getMetadataConfig()LX/3UK;
    .locals 7

    iget-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mockManager:LX/3iu;

    const-string v5, "metadata_config"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/settings/IMetaDataConfig$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/settings/IMetaDataConfig$$Impl$2;-><init>(Lcom/vega/settings/IMetaDataConfig$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = metadata_config time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3UK;->b()LX/3UK;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null metadata_config"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/settings/IMetaDataConfig$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/settings/IMetaDataConfig$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/settings/IMetaDataConfig$$Impl$3;-><init>(Lcom/vega/settings/IMetaDataConfig$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = metadata_config"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "metadata_config_com.vega.settings.IMetaDataConfig"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "metadata_config"
    ...
    iget-object v1, p0, Lcom/vega/settings/IMetaDataConfig$$Impl;->mStorage:LX/3iv;
