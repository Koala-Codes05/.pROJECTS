.class public Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/vega/settings/TemplateSearchTrendAbSettings;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x684ffc7
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl$1;

    invoke-direct {v0, p0}, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl$1;-><init>(Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;)V

    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->getConfig()LX/3bF;
...
.method public getConfig()LX/3bF;
    .locals 7

    iget-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mockManager:LX/3iu;

    const-string v5, "cc_liteeditor_watermark_tailleader_ab"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl$2;

    invoke-direct {v0, p0}, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl$2;-><init>(Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = cc_liteeditor_watermark_tailleader_ab time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3bF;->c()LX/3bF;

    move-result-object v4

    iget-object v1, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null cc_liteeditor_watermark_tailleader_ab"
    ...
    :cond_3
    iget-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl$3;

    invoke-direct {v0, p0}, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl$3;-><init>(Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;)V
    ...
    iget-object v2, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = cc_liteeditor_watermark_tailleader_ab"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "oversea_settings_com.vega.settings.TemplateSearchTrendAbSettings"
    ...
    :cond_1
    iget-object v0, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "cc_liteeditor_watermark_tailleader_ab"
    ...
    iget-object v1, p0, Lcom/vega/settings/TemplateSearchTrendAbSettings$$Impl;->mStorage:LX/3iv;
