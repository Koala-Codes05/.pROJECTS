...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/3F8;->a:LX/3F8;
    ...
    invoke-interface {v0}, LX/Rxt;->V()Lcom/vega/main/SettingsFusedTestConfig;

    move-result-object v0

    invoke-virtual {v0}, Lcom/vega/main/SettingsFusedTestConfig;->getEnableSettingsFusedTest()Z

    move-result v0

    sput-boolean v0, LX/3F8;->b:Z
    ...
    invoke-interface {v0}, LX/Rxt;->W()Lcom/vega/main/LibraFusedTestConfig;

    move-result-object v0

    invoke-virtual {v0}, Lcom/vega/main/LibraFusedTestConfig;->getEnableLibraFusedTest()Z

    move-result v0

    sput-boolean v0, LX/3F8;->c:Z
...
.method public final a()V
    ...
    sget-boolean v0, LX/3F8;->b:Z

    const-string v2, "PUBLISH_FUSED_TEST"

    const-string v1, "LV_PUBLISH_FUSED_TEST_EXCEPTION"

    if-eqz v0, :cond_0

    const-string v0, "[settings] report fused test exception!"
    ...
    :cond_0
    sget-boolean v0, LX/3F8;->c:Z

    if-eqz v0, :cond_1

    const-string v0, "[libra] report fused test exception!"
