...
# instance fields
.field public final a:Lcom/xt/retouch/business/templatetob/viewmodel/BusinessScaffoldViewModel;

.field public final b:LX/9zh;

.field public final c:LX/Gfy;

.field public final d:LX/9sn;


# direct methods
.method public constructor <init>(Lcom/xt/retouch/business/templatetob/viewmodel/BusinessScaffoldViewModel;LX/9zh;LX/Gfy;)V
    .locals 1
    ...
    iput-object p1, p0, LX/9tg;->a:Lcom/xt/retouch/business/templatetob/viewmodel/BusinessScaffoldViewModel;

    iput-object p2, p0, LX/9tg;->b:LX/9zh;

    iput-object p3, p0, LX/9tg;->c:LX/Gfy;

    invoke-virtual {p1}, LX/9zW;->aG()LX/9sn;

    move-result-object v0

    iput-object v0, p0, LX/9tg;->d:LX/9sn;

    return-void
.end method

.method private final a(I)LX/9Hw;
    .locals 3

    iget-object v0, p0, LX/9tg;->d:LX/9sn;

    invoke-interface {v0}, LX/9sn;->i()Ljava/util/List;
...
.method private final a(LX/9Hw;)LX/9Hw;
    .locals 24
    ...
    iget-object v1, v4, LX/9tg;->c:LX/Gfy;

    invoke-interface {v1, v3}, LX/9T5;->a(Ljava/lang/Object;)V

    iget-object v5, v4, LX/9tg;->d:LX/9sn;

    const/4 v1, 0x2

    const/4 v2, 0x0

    invoke-static {v5, v6, v2, v1, v10}, LX/9so;->a(LX/9sn;Lcom/xt/retouch/painter/function/api/IPainterText$CreationTextTemplateData;ZILjava/lang/Object;)LX/9Hw;

    move-result-object v1

    if-nez v1, :cond_1

    iget-object v0, v4, LX/9tg;->c:LX/Gfy;
    ...
    iget-object v5, v4, LX/9tg;->c:LX/Gfy;
    ...
    iget-object v8, v4, LX/9tg;->c:LX/Gfy;
    ...
    invoke-interface {v8, v7, v6, v5}, Lcom/xt/retouch/painter/function/api/IPainterCommon;->b(IFF)V
    ...
    iget-object v6, v4, LX/9tg;->c:LX/Gfy;

    invoke-interface {v0}, LX/9vi;->af_()I

    move-result v5

    invoke-interface {v6, v5}, Lcom/xt/retouch/painter/function/api/IPainterLayer;->aT(I)F

    move-result v5

    invoke-interface {v8, v7, v5}, Lcom/xt/retouch/painter/function/api/IPainterCommon;->a(IF)V

    iget-object v7, v4, LX/9tg;->c:LX/Gfy;
    ...
    invoke-interface {v7, v6, v5}, Lcom/xt/retouch/painter/function/api/IPainterLayer;->t(IZ)Landroid/graphics/PointF;
    ...
    invoke-interface {v8}, LX/9qn;->aX()I

    move-result v6

    invoke-interface {v8, v6, v5}, Lcom/xt/retouch/painter/function/api/IPainterLayer;->t(IZ)Landroid/graphics/PointF;
    ...
    :cond_3
    iget-object v11, v4, LX/9tg;->c:LX/Gfy;
    ...
    invoke-static {v6, v2, v5, v10}, LX/9qo;->a(Lcom/xt/retouch/painter/function/api/IPainterCommon;ZILjava/lang/Object;)V

    instance-of v6, v0, LX/9Nk;

    if-eqz v6, :cond_5

    if-eqz v0, :cond_5

    invoke-interface {v0}, LX/9Nk;->h()Ljava/lang/Float;
    ...
    invoke-interface {v1, v0, v5}, LX/9Nk;->a(FZ)V

    :cond_4
    iget-object v0, v4, LX/9tg;->c:LX/Gfy;

    invoke-static {v0, v2, v5, v10}, LX/9qo;->a(Lcom/xt/retouch/painter/function/api/IPainterCommon;ZILjava/lang/Object;)V
...
.method public static final a$0(LX/9tg;LX/9Hw;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 11
    ...
    invoke-static {p2, v0}, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->$instanceof(Ljava/lang/Object;I)Z
    ...
    iget-object v9, v3, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->l2:Ljava/lang/Object;

    check-cast v9, LX/9vi;

    iget-object v7, v3, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->l0:Ljava/lang/Object;
    ...
    iget-object v0, v7, LX/9tg;->a:Lcom/xt/retouch/business/templatetob/viewmodel/BusinessScaffoldViewModel;
    ...
    iget-object v3, v7, LX/9tg;->b:LX/9zh;
    ...
    invoke-direct {v7, v8}, LX/9tg;->a(LX/9Hw;)LX/9Hw;
    ...
    :cond_3
    iget-object v2, v7, LX/9tg;->c:LX/Gfy;
    ...
    iput-object v7, v3, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->l0:Ljava/lang/Object;

    iput-object v8, v3, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->l1:Ljava/lang/Object;

    iput-object v9, v3, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->l2:Ljava/lang/Object;

    iput v5, v3, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;->i5:I
    ...
    invoke-direct {v10, v0, v5}, Lkotlinx/coroutines/CancellableContinuationImpl;-><init>(Lkotlin/coroutines/Continuation;I)V
    ...
    invoke-direct/range {v6 .. v12}, LX/A2z;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V

    invoke-static {p0, v6, v5, p0}, LX/454;->a(Lkotlinx/coroutines/CoroutineScope;Lkotlin/jvm/functions/Function2;ILjava/lang/Object;)Lkotlinx/coroutines/Job;
    ...
    invoke-direct {v3, v7, p2, v0}, Lkotlin/coroutines/jvm/internal/ACImplS3S0501000_5;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V
...
.method public a(IF)V
    ...
    invoke-direct {p0, p1}, LX/9tg;->a(I)LX/9Hw;
...
.method public a(ILandroid/os/Bundle;)V
    ...
    iget-object v3, p0, LX/9tg;->a:Lcom/xt/retouch/business/templatetob/viewmodel/BusinessScaffoldViewModel;
...
.method public a(LX/9vi;)V
    ...
    iget-object v0, p0, LX/9tg;->b:LX/9zh;
