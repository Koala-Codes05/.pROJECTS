.class public Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/lemon/lv/config/CloseTextToAudioSettings;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x5dfe33cf
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl$1;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl$1;-><init>(Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;)V

    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->getConfig()Lcom/lemon/lv/config/CloseTextToAudioConfig;
...
.method public getConfig()Lcom/lemon/lv/config/CloseTextToAudioConfig;
    .locals 7

    iget-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mockManager:LX/3iu;

    const-string v5, "text_to_audio_entrance_control"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl$2;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl$2;-><init>(Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = text_to_audio_entrance_control time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v4, Lcom/lemon/lv/config/CloseTextToAudioConfig;

    if-nez v4, :cond_2

    const-class v1, Lcom/lemon/lv/config/CloseTextToAudioConfig;

    iget-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, Lcom/lemon/lv/config/CloseTextToAudioConfig;->create()Lcom/lemon/lv/config/CloseTextToAudioConfig;

    move-result-object v4

    iget-object v1, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null text_to_audio_entrance_control"
    ...
    :cond_3
    iget-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl$3;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl$3;-><init>(Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;)V
    ...
    iget-object v2, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = text_to_audio_entrance_control"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "common_settings_com.lemon.lv.config.CloseTextToAudioSettings"
    ...
    :cond_1
    iget-object v0, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "text_to_audio_entrance_control"
    ...
    iget-object v1, p0, Lcom/lemon/lv/config/CloseTextToAudioSettings$$Impl;->mStorage:LX/3iv;
