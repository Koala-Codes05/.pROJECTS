.class public Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = 0x66ab7921
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl$1;-><init>(Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;)V

    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->getConfig()LX/3lp;
...
.method public getConfig()LX/3lp;
    .locals 7

    iget-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "text_create_url_extract_config"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl$2;-><init>(Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = text_create_url_extract_config time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3lp;->g()LX/3lp;

    move-result-object v4

    iget-object v1, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null text_create_url_extract_config"
    ...
    :cond_3
    iget-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl$3;-><init>(Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = text_create_url_extract_config"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "common_settings_com.lemon.lv.config.TextCreateUrlExtractConfigSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "text_create_url_extract_config"
    ...
    iget-object v1, p0, Lcom/lemon/lv/config/TextCreateUrlExtractConfigSetting$$Impl;->mStorage:LX/3iv;
