.class public Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;
.super Ljava/lang/Object;

# interfaces
.implements Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting;


# static fields
.field public static final GSON:Lcom/google/gson/Gson;

.field public static final VERSION:I = -0x6928e16
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;
...
.method public constructor <init>(LX/3iv;)V
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mStickySettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mTransientSettings:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v0, LX/3iu;->b:LX/3iu;

    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl$1;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl$1;-><init>(Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;)V

    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mInstanceCreator:LX/34Z;

    iput-object p1, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iput-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
...
.method public bridge synthetic getConfig()LX/2Ew;
    ...
    invoke-virtual {p0}, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->getConfig()LX/3bN;
...
.method public getConfig()LX/3bN;
    .locals 7

    iget-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mockManager:LX/3iu;

    const-string v5, "cc_commercial_music_expand"
    ...
    :try_start_0
    iget-object v1, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mockManager:LX/3iu;

    new-instance v0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl$2;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl$2;-><init>(Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mExposedManager:Lcom/bytedance/news/common/settings/api/exposed/ExposedManager;
    ...
    iget-object v3, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "get settings key = cc_commercial_music_expand time = "
    ...
    :cond_1
    iget-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mCachedSettings:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mInstanceCreator:LX/34Z;
    ...
    invoke-virtual {v0}, LX/3bN;->b()LX/3bN;

    move-result-object v4

    iget-object v1, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;

    if-eqz v1, :cond_2

    const-string v0, "value == null cc_commercial_music_expand"
    ...
    :cond_3
    iget-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mStorage:LX/3iv;
    ...
    :try_start_1
    sget-object v1, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->GSON:Lcom/google/gson/Gson;

    new-instance v0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl$3;

    invoke-direct {v0, p0}, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl$3;-><init>(Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;)V
    ...
    iget-object v2, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v0, "value == null key = cc_commercial_music_expand"
...
.method public updateSettings(LX/43r;)V
    ...
    const-string v2, "common_settings_com.lemon.lv.config.CommercialMusicExpandConfigSetting"
    ...
    :cond_1
    iget-object v0, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->iEnsure:Lcom/bytedance/services/apm/api/IEnsure;
    ...
    const-string v4, "cc_commercial_music_expand"
    ...
    iget-object v1, p0, Lcom/lemon/lv/config/CommercialMusicExpandConfigSetting$$Impl;->mStorage:LX/3iv;
